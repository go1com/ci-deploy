...
RUN apt-get update && apt-get upgrade -y && apt-get install php5-cli php5-dev php5-curl php5-gd php5-mcrypt php5-mysql php5-sqlite build-essential libmcrypt-dev libicu-dev libxml2-dev libssl-dev curl git-core unzip python2.7 -y -qq && apt-get clean && rm -rf /var/lib/apt/lists/*
