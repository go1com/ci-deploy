...
RUN apt-get update -qq && apt-get install -yqq \
    ...
    && bash -c 'npm install -g bower yarn typescript jest grunt-cli jira-cmd phantomjs-prebuilt utf-8-validate bufferutil optipng jpegtran pngquant gifsicle bufferutil jshint ycssmin recess selenium-standalone webdriver-manager imagemin imagemin-gifsicle imagemin-jpegtran imagemin-optipng imagemin-pngquant optipng-bin jpegtran-bin newman serverless serverless-webpack webpack' \
